            ...
            <div className="contact_form_div">
                <form className="contact_form">
                    ...
                    <div className="form_groups">
                        ...
                        <input className="form-group_input" type="text" name="name" id="name" placeholder="Your Name"
                               required/>
                    </div>
                    {/* Email */}
                    <div className="form_groups">
                        <label htmlFor="email" className="form_group_label"></label>
                        <input className="form-group_input" type="email" name="email" id="email"
                               placeholder="Your Email" required/>
                    </div>
                    {/* Phone */}
                    <div className="form_groups">
                        <label htmlFor="phone" className="form_group_label"></label>
                        <input className="form-group_input" type="tel" name="phone" id="phone" placeholder="Your Phone"
                               required/>
                    </div>
                    ...
                    <div className="form_groups">
                        ...
                        <input className="form-group_input" type="text" name="company" id="company"
                               placeholder="You Company (Optional)"/>
                    </div>

                    {/* City */}
                    <div className="form_groups">
                        <label htmlFor="city" className="form_group_label"></label>
                        <input className="form-group_input" type="text" name="city" id="city"
                    ...
                    <div className="form_groups">
                        ...
                        <textarea name="message" id="message" required className="form-group_input input_message"
